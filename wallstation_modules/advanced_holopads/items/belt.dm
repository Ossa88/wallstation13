/*
ORGINAL FILE: code/game/objects/items/storage/belt.dm
...
//Holo Doctor Surgical Belt
/obj/item/storage/belt/medical/holosurgery
	icon_state = "medical"
	inhand_icon_state = "medical"
	worn_icon_state = "medical"
	preload = TRUE
...
/*
// Emergency Holo Doctor Normal Quality Tools - One or the other

/obj/item/storage/belt/medical/holosurgery/PopulateContents()
...
/obj/item/storage/belt/medical/holosurgery/get_types_to_preload()
	var/list/to_preload = list()
...
// Emergency Holo Doctor Advanced Quality Tools - One or the other
